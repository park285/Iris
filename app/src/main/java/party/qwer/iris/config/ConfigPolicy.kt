...
internal object ConfigPolicy {
    private val restartRequiredFields: Set<ConfigField> = setOf(
    ...
    val defaultRoutingPolicy: RoutingPolicy = RoutingPolicy(
    ...
    fun validate(state: UserConfigState): List<ConfigValidationError> = buildList {
