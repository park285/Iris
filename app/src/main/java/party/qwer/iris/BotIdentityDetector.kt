...
internal sealed interface BotUserIdResolution {
    val botId: Long
    data class Detected(override val botId: Long) : BotUserIdResolution
    data class ConfigFallback(override val botId: Long) : BotUserIdResolution
    data object Missing : BotUserIdResolution { override val botId: Long = 0L }
}

internal fun resolveBotUserId(detectedBotId: Long, configuredBotId: Long): BotUserIdResolution =
    when {
