...
class WebhookConfigUpdateTest {
    ...
    fun `updates default route endpoint and keeps default webhook in sync`() {
        val updated =
            updateWebhookConfig(
                ConfigValues(
                    ...
                    webhooks = mapOf("hololive" to "http://old-default", "chatbotgo" to "http://chatbotgo"),
                ),
        ...
        assertEquals("http://new-default", updated.webhooks["hololive"])
    ...
    fun `updates non default route without changing default endpoint`() {
        val updated =
            updateWebhookConfig(
                ConfigValues(
                    ...
                    webhooks = mapOf("hololive" to "http://default", "chatbotgo" to "http://old-chatbotgo"),
                ),
                route = "chatbotgo",
        ...
        assertEquals("http://default", updated.webhooks["hololive"])
    ...
    fun `clearing non default route removes override and keeps default route`() {
        val updated =
            updateWebhookConfig(
                ConfigValues(
                    endpoint = "http://default",
                    webhooks = mapOf("hololive" to "http://default", "chatbotgo" to "http://chatbotgo"),
                ),
                route = "chatbotgo",
                endpoint = "",
            )
