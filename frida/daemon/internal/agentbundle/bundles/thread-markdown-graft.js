...
var ENABLE_MARKDOWN_GRAFT_LOGS = false;
    ...
    for (const overload of overloads) {
      overload.implementation = function(...args) {
        ...
        if (plan.status === "inject" && plan.injection != null) {
          ...
          threadField.set(sendingLog, LongClass.valueOf(StringClass.valueOf(plan.injection.threadId)));
